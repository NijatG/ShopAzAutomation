...
public class FromCategoryToBasketObjects {

    private static WebElement element = null;

    public static WebElement kateqoriyalar_button(WebDriver driver) {
        element = driver.findElement(By.xpath("//*[@id=\"category-btn\"]/span"));
        return element;
    }
    public static WebElement texnikaVeElektronika_button(WebDriver driver) {
        element = driver.findElement(By.xpath("/html/body/app-root/app-views/app-app/app-header-main/header/div/div[3]/div/div/ul/li[1]/div/div/ul/li[1]/a"));
        return element;
    }
    public static WebElement mehsul_button(WebDriver driver) {
        element = driver.findElement(By.xpath("/html/body/app-root/app-views/app-app/app-category/app-category-single/main/div/div[3]/div[2]/div[1]/div[1]/product-card/a/div[2]/h4"));
        return element;
    }
