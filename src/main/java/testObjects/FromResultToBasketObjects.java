...
public class FromResultToBasketObjects {

    private static WebElement element=null;

    public  static WebElement axtar_textbox(WebDriver driver){
        element = driver.findElement(By.xpath("/html/body/app-root/app-views/app-app/app-header-main/header/div/div[2]/div/div/div[1]/div/form/input"));
        return element;
    }
    public  static WebElement mehsul_button(WebDriver driver){
        element = driver.findElement(By.xpath("/html/body/app-root/app-views/app-app/app-search/main/div/div[3]/div[2]/div/div[1]/product-card/a/div[2]/h4"));
        return element;
    }
